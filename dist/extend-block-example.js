...
},{"lodash.assign":"../../node_modules/lodash.assign/index.js"}],"add-font-family.js":[function(require,module,exports) {
"use strict";
...
var enableSpacingControlOnBlocks = ['core/paragraph', 'core/heading', 'core/quote', 'core/verse', 'core/list']; // Available spacing control options
...
var withSpacingControl = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
    ...
    var fontFamily = props.attributes.fontFamily; // add has-spacing-xy class to block

    if (fontFamily) {
      props.attributes.className = "".concat(fontFamily);
    }

    return React.createElement(Fragment, null, React.createElement(BlockEdit, props), React.createElement(InspectorControls, null, React.createElement(PanelBody, {
      title: __('Font Family Selector'),
      initialOpen: true
    }, React.createElement(SelectControl, {
...
require("./add-font-family");
},{"./spacing-control":"spacing-control.js","./add-font-family":"add-font-family.js"}]},{},["extend-block-example.js"], null)
